...
Данные настройки были выявлены путем тестирования различных моделей с различными параметрами. Наименьшей ошибки удалось добиться именно с этими параметрами. Ошибка составляет около 6%.  
